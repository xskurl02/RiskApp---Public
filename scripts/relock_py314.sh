...
then
  ...
  echo "  PYTHON_BIN=/path/to/python3.11 bash scripts/relock_py314.sh"
  echo "  PYTHON_BIN=/path/to/python3.12 bash scripts/relock_py314.sh"
  echo "  PYTHON_BIN=/path/to/python3.13 bash scripts/relock_py314.sh"
  echo "  PYTHON_BIN=/path/to/python3.14 bash scripts/relock_py314.sh"
  exit 1
fi
...
echo
echo "Next:"
echo "  bash scripts/setup_py314_env.sh"
